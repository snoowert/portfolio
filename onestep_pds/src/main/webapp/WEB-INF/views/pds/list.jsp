                    ...
                    <c:forEach items="${pdsList}" var="pds">
                        <tr>
                            ...
                            white-space: nowrap; text-overflow: ellipsis;">
                                <a href="detail.do?pdsid=${pds.pdsid }&from=list">
                                    <span class="col-sm-12 ">${pds.pdstitle }</span>
                                </a>
                            </td>
                            <td>${pds.writer }</td>
                            <td>
                                <fmt:formatDate value="${pds.pdsregdate }" pattern="yyyy-MM-dd"/>
                            </td>
                            <td><span class="badge bg-red">${pds.pdsviewpoint }</span></td>
                        </tr>
                    </c:forEach>
                </tbody>
            </table>
