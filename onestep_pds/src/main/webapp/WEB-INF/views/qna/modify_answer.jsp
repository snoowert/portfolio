    ...
    <div class="row justify-content-center">
        <div class="col-md-9">
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    <form role="form" method="post" action="/qna/modify_answer" name="modifyanswerForm" onsubmit="return false;">
                        <input type="hidden" name="qnaid" value="${answer.qnaid }" />
                        <input type="hidden" name="answerid" value="${answer.answerid }" />
                        <div class="form-group">
                            <input type="text" id="writer" readonly name="writer" class="form-control" value="${answer.writer }"> 
                            <input type="hidden" id="memberid" readonly	name="memberid" class="form-control"  value="${answer.memberid }">
                        </div>
                        <div class="form-group">
                            <div id="content"></div>  
