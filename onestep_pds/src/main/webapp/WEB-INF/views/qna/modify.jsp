    ...
    <div class="row justify-content-center">
        <div class="col-md-9">
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    <form role="form" method="post" action="/qna/modify.do" name="modifyForm" onsubmit="return false;">
                        <input type="hidden" name="qnaid" value="${qna.qnaid }" />
                        <div class="form-group"> 
                            <input type="text" id="qnatitle" name='qnatitle' class="form-control" value="${qna.qnatitle }">
                        </div>
                        <div class="form-group">
                            <input type="text" id="writer" readonly name="writer" class="form-control" value="${qna.writer }"> 
                            <input type="hidden" id="memberid" readonly	name="memberid" class="form-control"  value="${qna.memberid }">
                        </div>
                        <div class="form-group">
                            <div id="content"></div>  
